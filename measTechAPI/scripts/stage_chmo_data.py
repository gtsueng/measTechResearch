"""Stage CHMO source data into DATA_ARCHIVE_ROOT/chmo/current."""
...
def main():
    ...
    parser.add_argument("--download-latest", action="store_true", help="Download the latest CHMO CSV from BioPortal first.")
