"""Stage OBI source data into DATA_ARCHIVE_ROOT/obi/current."""
...
def main():
    ...
    parser.add_argument("--download-latest", action="store_true", help="Download the latest OBI CSV from BioPortal first.")
