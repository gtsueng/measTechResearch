"""Stage EFO source data into DATA_ARCHIVE_ROOT/efo/current."""
...
def main():
    ...
    parser.add_argument("--download-latest", action="store_true", help="Download the latest EFO CSV from BioPortal first.")
