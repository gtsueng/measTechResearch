"""Stage BAO source data into DATA_ARCHIVE_ROOT/bao/current."""
...
def main():
    ...
    parser.add_argument("--download-latest", action="store_true", help="Download the latest BAO CSV from BioPortal first.")
