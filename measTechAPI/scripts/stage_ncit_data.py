"""Stage NCIT source data into DATA_ARCHIVE_ROOT/ncit/current."""
...
def main():
    ...
    parser.add_argument("--download-latest", action="store_true", help="Download the latest NCIT CSV from BioPortal first.")
